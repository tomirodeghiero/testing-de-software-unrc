...
Este TP lo deje organizado por ejercicio, igual que en `tp1`.

- `ejercicio1/README.md`
- `ejercicio2/README.md`
- `ejercicio3/README.md`
- `ejercicio4/README.md`
- `ejercicio5/README.md`
- `ejercicio6/README.md`

El codigo base que dio la catedra esta en:

- `src/main/java/assignment2_exercises/SimpleRoutines.java`

Y para el ejercicio 2 agregue estos tests:
...
Para el ejercicio 5 agregue:

- `src/test/java/assignment2_exercises/ZuneBugParameterizedTest.java`
- correccion en `src/main/java/assignment2_exercises/ZuneBug.java`

Para el ejercicio 6 agregue:

- `src/test/java/assignment2_exercises/queue/BoundedQueueParameterizedTest.java`
- implementacion de `repOK` en `src/main/java/assignment2_exercises/queue/BoundedQueue.java`
